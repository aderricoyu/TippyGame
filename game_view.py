class GameView:
    ...
    def play(self):
        ...
        print(self.state)
        print()
        while not self.state.over and len(self.state.possible_next_moves()) != 0:
...
if __name__ == '__main__':
    ...
    while not g in game_state.keys():
        g = input('s to play Subtract Square, t for Tippy ')
    s = ''
    while not s in strategy.keys():
        s = input('r for random strategy for computer, m for minimax for computer ')
